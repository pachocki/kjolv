    ...
    <div className="  text-white relative  h-full overflow-hidden pb-5 ">
      ...
      <div className="bg-black relative ">
        <div className="2xl:max-w-[2000px] xl:max-w-[1440px] mx-auto relative z-20 ">
          <div
            className=" flex flex-col w-full  gap-3 px-10 pt-24 pb-10 relative   xl:pb-5 lg:pt-20 sm:px-5  "
            data-aos="fade-up"
            data-aos-duration="500"
          >
            <h1 className="w-full text-5xl font-bold  leading-normal xl:text-4xl md:text-3xl sm:text-xl xs:text-[1rem] ">
              {" "}
              {line1}
              <br />
              {line2}
          ...
          <div
            className="flex justify-center px-10 sm:px-5 xs:px-2"
            data-aos="zoom-in"
